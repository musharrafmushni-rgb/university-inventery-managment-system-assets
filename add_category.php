...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($category_name)) {
        ...
        $check = $conn->prepare("SELECT * FROM asset_categories WHERE category_name = ?");
...
<head>
    ...
    <title>Add Category - <?php echo SYSTEM_NAME; ?></title>
    <style>
        :root {
            --primary: #4a90e2;
            --secondary: #2c3e50;
    ...
    <div class="main-content">
        ...
        <?php if(isset($success)): ?>
            <div class="notification success">
                ✅ <?php echo $success; ?>
                <br><br>
                <button class="btn btn-primary" onclick="location.href='categories.php'">View All Categories</button>
            </div>
        <?php endif; ?>
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" 
                              rows="4" placeholder="Add a description for this category...
Example: Used for office computers and laptops"><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
                </div>
